...
for parameters in lenticular_list:
    ...
    with open('Actual Data/Unblocked Files/Changing Lens/{ratio:.2f} mu, {n} n.csv'.format(ratio=p_lenticular / R_lenticular, n=n_lenticular), 'a') as f_rays:
        f_rays.truncate(0)
            ...
            print(
                ('ratio = {ratio}, ' +
                 ...
                 'avg angles = {average_angles}, total pos = {total_positions}, expected pos = {expected_pos}')
                    ...
                    .format(ratio=p_lenticular/R_lenticular,
    ...
    with open('Actual Data/Unblocked Files/Changing Lens/{ratio} mu, {n} n info.csv'.format(ratio=p_lenticular / R_lenticular, n=n_lenticular), 'w') as f_info:
